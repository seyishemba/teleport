...
export class LoginService {
    ...
    isEmailRegistered(emailAddress: string, userType: UserTypeEnum) {
        const input: CheckForEmailModel = new CheckForEmailModel({ emailAddress, userType });
        return this._tokenAuthService.isEmailRegistered(input);
    }
