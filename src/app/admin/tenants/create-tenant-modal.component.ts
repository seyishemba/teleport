...
export class CreateTenantModalComponent extends AppComponentBase {
    ...
    constructor(
        ...
        super(injector);
        this.appBaseUrl = UrlHelper.extractDomainFromUrl(AppConsts.appBaseUrl);
    }
    ...
    save(): void {
        ...
        this.tenant.platformDomain = this.buildSubdomainUrl(AppConsts.appBaseUrl, this.tenant.tenancyName);
        this._tenantService
    ...
    private buildSubdomainUrl(originalUrl: string, subdomain: string): string {
